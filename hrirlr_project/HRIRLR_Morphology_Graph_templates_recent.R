...
dev.off()
#----------------------- Bar Graph Dendritic complexity-index CA1 basal
x11(h=5,3.5)
jpeg("F:/DATA/PostDoc1_Marian/HRIRLR/Complete_Trace_files_HRIRLR/R_files/HRIRLR_CA1_dci_basal.jpeg",units="in",res=600,height=5,width=3.5,pointsize=13)
par(mar=c(3,6.5,3,0.8) + 0.1)
par(lwd=2)
bargraph.CI(col=c("black","grey","white"),yaxt="n",cex.axis=1.3,lwd=c(5,5,5),ylim=c(0,15000),x.factor=as.factor(tca1basal[,"group"]),response=t_dci,data=tca1basal)
axis(side=2, at=c(0,5000,10000,15000),pos=0,cex.axis=1.6,adj=0,lwd=2,labels= c("0","5","10",expression(15%*%10^3)),las=2)
dev.off()
#----------------------- #Bar Graph Branching Points CA1 basal
x11(h=5,3.5)
jpeg("F:/DATA/PostDoc1_Marian/HRIRLR/Complete_Trace_files_HRIRLR/R_files/HRIRLR_CA1_bp_basal.jpeg",units="in",res=600,height=5,width=3.5,pointsize=13)
par(mar=c(3,6.5,3,0.8) + 0.1)
par(lwd=2)
bargraph.CI(col=c("black","grey","white"),yaxt="n",cex.axis=1.3,lwd=c(5,5,5),ylim=c(0,10),x.factor=as.factor(tca1basal[,"group"]),response=t_bp,data=tca1basal)
axis(side=2, at=c(0,5,10),pos=0,cex.axis=1.6,adj=0,lwd=2,las=2)
dev.off()
#-----------------------
#================================================================================ BLA
#----------------------- Sholl plot Dendritic length BLA apical
x11(h=4,5)
par(mar=c(4,4,3,2) + 0.1)
#jpeg("F:/DATA/PostDoc1_Marian/HRIRLR/Complete_Trace_files_HRIRLR/R_files/HRIRLR_BLA_Sholl.jpeg",units="in",res=600,height=4,width=5,pointsize=12)
newline(x.factor=as.factor(shollbla[,"sholl"]),pin=c(4,5),response=dl,group=group,data=shollbla,cex=1.3,legend=0,pch=c(21,21,21),bordercol=c("black","black","black"),fillcol=c("black","grey","white"),err.col=c("black"),cex.axis=1.3,x.cont=T,xlim=c(35,300),ylim=c(0,200),xlab="",ylab="",xaxt="n",yaxt="n",lwd=2,bty="n",lty=c(1,1,1))
axis(side=2, at=c(-10,0,50,100,150,200),pos=24,cex.axis=1.2,adj=0,lwd=2,las=2)
axis(side=1, at=c(20,50,100,150,200,250,300),pos=-8,cex.axis=1.2,lwd=2)
#dev.off()
#----------------------- Bar Graph Dendritic complexity-index BLA
x11(h=5,3.5)
#jpeg("F:/DATA/PostDoc1_Marian/HRIRLR/Complete_Trace_files_HRIRLR/R_files/HRIRLR_BLA_dci.jpeg",units="in",res=600,height=5,width=3.5,pointsize=13)
par(mar=c(3,6.5,3,0.8) + 0.1)
par(lwd=2)
bargraph.CI(col=c("black","grey","white"),yaxt="n",cex.axis=1.3,lwd=c(5,5,5),ylim=c(0,30000),x.factor=as.factor(tbla[,"group"]),response=t_dci,data=tbla)
axis(side=2, at=c(0,10000,20000,30000),pos=0,cex.axis=1.6,adj=0,lwd=2,labels= c("0","10","20",expression(30%*%10^3)),las=2)
#dev.off()
#----------------------- #Bar Graph Branching Points BLA
x11(h=5,3.5)
jpeg("F:/DATA/PostDoc1_Marian/HRIRLR/Complete_Trace_files_HRIRLR/R_files/HRIRLR_BLA_bp.jpeg",units="in",res=600,height=5,width=3.5,pointsize=13)
par(mar=c(3,6.5,3,0.8) + 0.1)
par(lwd=2)
bargraph.CI(col=c("black","grey","white"),yaxt="n",cex.axis=1.3,lwd=c(5,5,5),ylim=c(0,20),x.factor=as.factor(tbla[,"group"]),response=t_bp,data=tbla)
axis(side=2, at=c(0,5,10,15,20),pos=0,cex.axis=1.6,adj=0,lwd=2,las=2)
dev.off()
#-----------------------
